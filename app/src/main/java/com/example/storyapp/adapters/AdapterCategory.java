...
import com.example.storyapp.activities.PdfListAdminActivity;
import com.example.storyapp.databinding.RowCategoryBinding;
import com.example.storyapp.filters.FilterCategory;
...
public class AdapterCategory extends RecyclerView.Adapter<AdapterCategory.HolderCategory> implements Filterable {
    ...
    public ArrayList<ModelCategory> categoryArrayList,filerList;
...
holder.itemView.setOnClickListener(new View.OnClickListener() {
    ...
    public Filter getFilter() {
        if(filter==null){
            filter=new FilterCategory(filerList, this);
        }
        return filter;
    }
