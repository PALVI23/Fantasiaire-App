...
import static com.example.storyapp.Constants.MAX_BYTES_PDF;
...
import com.example.storyapp.adapters.AdapterPdfAdmin;
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        reference.child(bookId)
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        Log.d(TAG, "onSuccess: Deleted fro db too");
...
//                                .pages(0)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressBar.setVisibility(View.INVISIBLE);
                        Log.d(TAG, "onFailure: failed getting the file from url due to " + e.getMessage());
                    }
                });
    }
        ...
        if (firebaseAuth.getCurrentUser()==null){
            ...
            ref.child(firebaseAuth.getUid()).child("Favourites").child(bookId)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(context, "Failed to add to Favourites list due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        if (firebaseAuth.getCurrentUser()==null){
            ...
            ref.child(firebaseAuth.getUid()).child("Favourites").child(bookId)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void unused) {
                            Toast.makeText(context, "Removed from Favourites list...", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(context, "Failed to remove from Favourites list due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
