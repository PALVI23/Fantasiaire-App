...
import com.example.storyapp.adapters.AdapterComment;
import com.example.storyapp.adapters.AdapterPdfFavourite;
import com.example.storyapp.databinding.ActivityPdfDetailBinding;
import com.example.storyapp.databinding.DialogCommentAddBinding;
import com.example.storyapp.models.ModelComment;
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(isInMyFavourite){
                            ...
                            binding.favouriteBtn.setText("Unlike");
                        }
                        else{
                            binding.favouriteBtn.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.drawable.ic_favourite_border_white, 0, 0);
                            binding.favouriteBtn.setText("Like");
                        }
                    }
