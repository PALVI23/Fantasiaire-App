...
import com.example.storyapp.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
        ...
        storageReference.putFile(pdfUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Log.d(TAG, "onSucess : PDF uploaded to Storage...");
                        Log.d(TAG, "onSucess : getting pdf url...");
    ...
    private void uploadPdfInfoToDb(String uploadedPdfUrl, long timestamp)   {
        Log.d(TAG, "uploadPdfToStorage: uploading PDf info into the Firebase db...");
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        progressDialog.dismiss();
                        Log.d(TAG, "onSucsess: Successfully uploaded...");
    ...
    private void pdfPickIntent() {
        Log.d(TAG, "pdfPickIntent: satrting pdf pick intent");
